  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 -mt-16">
        ...
        <form onSubmit={handleSearch} className="w-full max-w-2xl mt-12 animate-fade-in-up-delayed">
          <div className={`relative group transition-all duration-500 ${isFocused ? 'scale-105' : ''}`}>
            ...
            <div className="relative flex items-center bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl overflow-hidden transition-all duration-300 hover:bg-white/15">
              <input
                ...
                className="flex-1 px-6 md:px-8 py-4 md:py-5 text-base md:text-lg text-white placeholder-slate-300/60 bg-transparent focus:outline-none"
              />
              <button
                type="submit"
                className="px-6 md:px-10 py-4 md:py-5 bg-slate-700/50 hover:bg-slate-600/60 text-white font-medium transition-all duration-300 flex items-center gap-2 group-hover:px-12"
              >
